...
async function loadData(){
  const files={curated:'datacentres.json',planning:'planning.json',osm:'datacentres-osm.json',grid:'grid.json',ownership:'ownership.json',incentives:'incentives.json',investigations:'investigations.json',registry:'sources/open-data-sources.json'};
  const failures=[];
